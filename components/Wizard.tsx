...
const Wizard = () => {
  ...
  className='flex-1'>
    ...
    >
     <div className='flex flex-col justify-center items-start bg-gray-700/50 backdrop-blur-lg  rounded-lg pt-10 pb-2 shadow-lg mb-14 md:mb-0 lg:mb-6 md:mr-6 lg:mr-28'>
        <FlipWordsHeading />
